document.addEventListener('DOMContentLoaded', () => {
	...
	function checkForMatch () {
		...
		if (chosenCards[0] === chosenCards[1]) {
			allImages[chosenCardsIdOne].setAttribute('src', 'images/blank.png');
			allImages[chosenCardsIdTwo].setAttribute('src', 'images/blank.png');
			...
			allImages[chosenCardsIdOne].setAttribute('src', 'images/coverImg.jpg');
			allImages[chosenCardsIdTwo].setAttribute('src', 'images/coverImg.jpg');
